...
try
{
    ...
    $emailTextHtml .= "<h3>New message from offerte</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br><br><br></p>";
...
$mail->AddReplyTo($fromEmail, $fromName . ' ' . $_POST['achternaam']);
    ...
    $mail->Subject = 'New message from offerte';
